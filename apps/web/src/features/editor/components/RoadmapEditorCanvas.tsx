...
import { RoadmapNode } from '@/features/roadmap/components/RoadmapNode';
import type { ProgressStatus } from '@/features/roadmap/types';
...
import type { RoadmapEditorCanvasProps } from '../types';
...
export function RoadmapEditor({ slug, onSave, onError }: RoadmapEditorCanvasProps) {
